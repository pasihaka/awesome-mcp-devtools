...
- [pasihaka/mcp-sentinel](https://github.com/pasihaka/mcp-sentinel) 📇 - Edge-native synthetic monitor and protocol sentinel for remote MCP servers. Automated JSON-RPC 2.0 handshake validation, breaking schema drift detection, credential leak scanning, and dynamic SVG status badges.
